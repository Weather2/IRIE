...
C
         IF (IGET(184).GT.0) THEN
          IF (LVLS(LP,IGET(184)).GT.0) THEN
            ...
            CALL BOUND(GRID1,0.,H99999,IMOUT,JMOUT)
            ID(1:25)=0
            CALL OUTPUT(IOUTYP,IGET(184),LP,GRID1,IMOUT,JMOUT)
          ENDIF
         ENDIF
C
