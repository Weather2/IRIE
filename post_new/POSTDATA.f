...
C234567890123456789012345678901234567890123456789012345678901234567890
     ...
     &                      /1,'SNOW WATER EQUIVALNT',066,001/
     ...
     &                      /0,'U COMP STORM MOTION ',196,101/
      DATA IFILV(164),AVBL(164),IQ(164),IS(164)
     &                      /0,'V COMP STORM MOTION ',197,101/
     ...
     &                      /1,'IVAN CLOUD FRACTION ',240,235/
      DATA IFILV(184),AVBL(184),IQ(184),IS(184)
     &                      /1,'IVAN CLOUD ON P SFCS',236,100/
      DATA IFILV(185),AVBL(185),IQ(185),IS(185)
     &                      /1,'IVAN CONVE ON P SFCS',203,100/
C
      END
