...
C
C$$$
Cmp      PARAMETER(PI=3.14159265358979,DPR=180./PI)
Cmp      PARAMETER(CRDLIM=0.9999999)
      DOUBLE PRECISION PI,DPR,CRDLIM
      DOUBLE PRECISION CTLAT,STLAT,CFLAT,SFLAT,CDLON,SDLON,CRD,CRD2
      DOUBLE PRECISION SRD2RN,STR,CTR,SFR,CFR
      PARAMETER(PI=3.1415926535897932384626433833,DPR=180./PI)
      PARAMETER(CRDLIM=1.E-10)
C - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
