...
C
Cmp	write(6,*) 'getting GDS...KPTR values (1:8) ', (KPTR(I),I=1,8)
C
CCCCCCCCCCCCCCCCCCCCCCCC
Cmp	write(6,*) 'searching for KGDS(1) at KPTR(8)= ', KPTR(8)
      CALL GBYTEC(MSGA,KGDS(1),KPTR(8),8)
Cmp	write(6,*) 'returned KGDS(1)= ', KGDS(1)
...
Cmp          PRINT *,'NON STANDARD GRID, CENTER = ',KPDS(1)
          J      = KGDS(2) * KGDS(3)
          KPTR(10) = J
          DO 600 I = 1, J
              KBMS(I) = .TRUE.
